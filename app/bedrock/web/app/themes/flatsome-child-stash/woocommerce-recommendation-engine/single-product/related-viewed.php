...
if ( $products && is_array( $products ) && count( $products ) ) :
	...
	<div class="related related-products-wrapper product-section products-customers-also-viewed">

	<?php
		$heading = apply_filters( 'woocommerce_recommendation_engine_label_also_viewed', $label );
